...
/**
    ...
    class Debug implements MultitonInterface
    {
         ...
         * @return string
         */
        public function vardump($input, $level = 0, array $objInstances = array())
        {
            $type = gettype($input);
            $ln = $this->indentLine();
                    ...
                    if ($len > 0) {
                        ...
                        if ($level < $this->depthLimit) {
                            foreach ($input as $k => $v) {
                                ...
                                $_v = $this->vardump($v, $level, $objInstances); //recursive
                        ...
                        if ($level < $this->depthLimit) {
                            ...
                            if ($this->hasFlag(self::SHOW_CONSTANTS)) {
                                ...
                                foreach ($ReflectionObj->getConstants() as $k => $v) {
                                    ...
                                    $output .= $this->templateVar(
                                        ...
                                        $k,
                                        self::$CONSTANT,
                                        $this->vardump($v, $level, $objInstances) //recursive
                                    );
                                    $output .= ",";
                                    ++$prop_count;
                                }
                            ...
                            foreach ($Properties as $Property) {
                                ...
                                $output .= $this->templateVar(
                                        ...
                                        $k,
                                        $prop_type,
                                        $this->vardump($v, $level, $objInstances) //recurse
                                );
                                $output .= ",";
                                ++$prop_count;
                            }
